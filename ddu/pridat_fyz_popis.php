<?php
	...
	if (empty($k))
	{
		...
		echo "<form action='pridat_fyz_popis.php?id=$id&k=2' method='POST'>
...
<p>Poznámka:
<br><textarea rows='3' name='poznamka' cols='48'></textarea>

<p>Zdravotní stav:
<br><textarea rows='3' name='zdravotni_stav' cols='48'></textarea>
...
<p><input type='submit' value='ok'>
	...
	foreach ($get as $value) {
		...
		$sql = "
			...
			'$dite_id','$barva_oci','$barva_vlasu','$styl_vlasu','$oblicej','$nos','$usta','$zuby','$postava','$vousy','$vyska','$vaha','$poznamka','$zdravotni_stav')
		";
		...
		echo "<p><a href='podrobnosti_fyz_popis.php?id=$dite_id'>zpět</a>";
	}
		/*****/
		include "foot.php";
	}
