<?php
	...
	if (logon())
	{
		...
		include "head.php";
		/*****/
		$upravit = "upravit_fyz_popis.php?id=$id";
	...
	echo "
		<table width='100%' border='$border'>
			...
			<tr>
				<td width='50%'>
				Styl vlasů: <b>".styl_vlasu($d["stil_vlasu"])."</b>
				</td>
				<td width='50%'>
	...
	else echo "Žádaná data v databázi.<p><a href='pridat_fyz_popis.php?id=$id'>Přidat fyzický popis</a>";
		/*****/
		include "foot.php";
	}
	else
