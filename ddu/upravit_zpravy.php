<?php
	...
	if (empty($k))
	{
		...
		echo "<form action='upravit_zpravy.php?k=2' method='POST'>
			<p>Název zprávy:
	...
	foreach ($get as $value) {
		...
		$sql = "
			UPDATE `$db`.`zpravy` SET `nazev` = '$nazev',
`zprava` = '$zprava' WHERE `zpravy`.`id` = $id;
		";
		...
		echo "<p><a href='podrobnosti_zpravy.php?id=$id'>zpět</a>";
	}
		/*****/
		include "foot.php";
	}
